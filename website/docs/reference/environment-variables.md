...
| `AURIKO_API_KEY` | Auriko API key ([auriko.ai](https://auriko.ai/)) |
| `AURIKO_BASE_URL` | Override Auriko base URL (default: `https://api.auriko.ai/v1`) |
